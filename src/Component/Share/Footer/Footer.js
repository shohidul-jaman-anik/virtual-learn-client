...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-base-100 text-base-content shadow-lg">
                <div>
                    <span className="footer-title">Cources</span>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-100 text-base-content border-base-300 shadow-lg">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Virtual-Learn Ltd. <br />Providing reliable online learning plartform since 2002</p>
                </div>
